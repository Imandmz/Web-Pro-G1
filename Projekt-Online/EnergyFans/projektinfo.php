...
<head>
  ...
  <style>
    body {
      ...
      color: white; /* Helle Textfarbe für den gesamten Text */
    }
    .info-box {
      background-color: rgba(0, 0, 0, 0.7); /* Ein dunklerer Hintergrund für den Info-Bereich */
      padding: 30px;
      border-radius: 15px;
      margin-top: 100px;
      color: white; /* Sicherstellen, dass der Text innerhalb der Info-Box weiß ist */
    }
    a {
      color: #ffeb3b; /* Gelbe Links */
      text-decoration: underline;
    }
    a:hover {
      color: #ffd54f; /* Hellgelber Hover-Effekt */
    }
    h2, h3, h4 {
      color: #f8f9fa; /* Helle Farben für die Überschriften */
    }
  </style>
</head>
<body>
